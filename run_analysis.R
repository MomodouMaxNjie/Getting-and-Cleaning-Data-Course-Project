...
# 0. Download dataset in data directory whithin the default RSTUDIO Working folder called Data Science Course
...
# 4.  labelling of the data set with descriptive variable names done above.
